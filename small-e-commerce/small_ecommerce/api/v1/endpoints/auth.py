...
from small_ecommerce.common import enums, exceptions
from small_ecommerce.common.secure import create_access_token
from small_ecommerce.core.settings import Settings, get_settings
from small_ecommerce.db import get_db_session
from small_ecommerce.schemas.auth import RegisterUser
from small_ecommerce.services import auth as auth_service
...
def signup(
    ...
    from small_ecommerce.schemas.user import UserCreate
